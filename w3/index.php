...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
    <div class="container">
      <a class="navbar-brand" href="index.php"><img src="land-rover-logo-png_seeklogo-201638.png" width="50px" style="margin-right: 30px;"> Land Rover Rental</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-lg-center">
          ...
          <li class="nav-item ms-lg-2 mt-2 mt-lg-0">
            <span class="nav-link"><i class="bi bi-person-circle"></i> <?= $displayUsername; ?></span>
          </li>
          <li class="nav-item ms-lg-2 mt-2 mt-lg-0">
